...
function Header() {
    return (
        ...
        <div className="list-none border-none bg-white p-2 text-gray-600 rounded-xl shadow-lg w-45 absolute hidden group-hover:flex flex-col top-15">
                        <li className="flex gap-1 hover:bg-sky-200 rounded-lg "> <MdSupport size="20" />Support </li>
                        <li className="flex gap-1 hover:bg-sky-200 rounded-lg pt-3"> <GrDocumentText size="20" />Documentation</li>
                        <hr></hr>
                        <li className="flex gap-1 hover:bg-sky-200 rounded-lg pt-3"><IoCloudDownloadSharp size="20" />Buy Booking!</li>
                        <hr></hr>
                        <li className="flex gap-1 hover:bg-sky-200 rounded-lg pt-3"> Components</li>
                    </div>
                </div>
                <div className="flex pt-10 pl-32 gap-10 font-arial">
                    <a className="flex gap-1 hover:bg-sky-100 rounded-lg " href="#hotel"><FaHotel size="20" />Hotel</a>
                    <a className="flex gap-1 hover:bg-sky-100 rounded-lg" href="#flight"><MdFlight size="20" /> Flight</a>
                    <a className="flex gap-1 hover:bg-sky-100 rounded-lg" href="#tour"> <FaGlobeAmericas size="20" />Tour</a>
                    <a className="flex gap-1 hover:bg-sky-100 rounded-lg" href="#cab"> <FaCarAlt size="20" />Cab</a>
                </div >
                <div className="group relative">
                    ...
                    <div className="absolute hidden group-hover:block border-none bg-white rounded-lg shadow-xl w-90 py-5 px-5 right-0">
                        ...
                        <button className="text-red-600 bg-red-100 rounded-m relative left-5 top-0 text-xs">4 new</button>
                        <div className="text-xs text-blue-600 relative left-30 ">Clear all</div>
                        </div>
                        <div className="pt-10 bg-sky-50 hover:bg-sky-100 rounded-lg">
                         <div className="font-bold ">New! Booking flights from New York</div>
                        <div className="text-gray-400">
                        <div className="text-sm">Find the flexible ticket on flights around the world.Start searching today </div>
                        <div>05 Feb 2024</div>
                        </div>
                        </div>

                        <div className="pt-8 hover:bg-sky-100">
                        <div className="font-bold">sunshine saving are here save 30% or more on a stay</div>
                        <div className="text-gray-400">24 Aug 2024</div>
                        </div>
                        <div className="pt-10 pl-15 cursor-pointer">
                           <div className="text-sky-600 text-sm">see all incoming activity</div> 
                        </div>
                    </div>
                </div>
                <div className="group relative">
                    <img className="w-10 h-10 rounded-lg relative top-5 left-5
        ...
        <div className="absolute hidden text-gray-700 group-hover:block border-none bg-white rounded-lg shadow-lg w-65 h-80 top-18 right-0">
                   <img className="rounded-full w-10 h-10 relative top-5 left-5" src="logo02.jpg"></img>
                <span className="absolute top-5 left-20 font-bold">Lori Ferguson</span>
            <p className="absolute top-10 left-20 text-sm">example@gmail.com</p>
                        <div >
                        <ul className="relative top-10 left-8 cursor-pointer">
                         <li className="flex hover:text-blue-500 rounded-lg"> <CiBookmarkCheck size="20" />My Bookings</li>
                    <li className="flex pt-3 hover:bg-sky-100 hover:text-blue-500 rounded-lg "><CiHeart size="20" />My Wishlist</li>
                         <li className="flex pt-3 hover:bg-sky-100 rounded-lg"><CiSettings size="20" />Settings</li>
                         <li className="flex pt-3 hover:bg-sky-100 rounded-lg"><IoMdHelpCircleOutline size="20" /> Help Center</li>
                         <li className="flex pt-3 hover:bg-red-100 rounded-lg"> <LiaSignOutAltSolid size="20"/>Sign Out</li>
                        </ul>
                        </div>
                       
        <span className="absolute top-60 left-8 flex gap-5 pt-10 cursor-pointer ">Mode:
