...
absolute hidden group-hover:flex flex-col">
                    ...
                    <div class=" border-none relative group cursor-pointer hover:bg-sky-50">
                        ...
                        <div className="list-none border-none bg-white p-6 text-gray-600 rounded-lg shadow-lg w-60 
            absolute hidden group-hover:flex flex-col">
        ...
        <div class="flex border-none relative group pt-11 pl-10 hover:bg-white rounded-lg cursor-pointer ">
            ...
            absolute hidden group-hover:flex flex-col top-15">
                        <li class="flex gap-1 "> <MdSupport size="20" />Support </li>
                        <li class="flex "> <GrDocumentText size="20" />Documentation</li>
                        <hr></hr>
                        <li class="flex "><IoCloudDownloadSharp size="20" />Buy Booking!</li>
                        <hr></hr>
 ...
 <div className="absolute hidden group-hover:block border-none bg-white rounded-lg shadow-lg w-75 h-90 right-5">
 <span class="font-bold text-sm ">Notification</span>
    <button class="text-red-600 bg-red-100 rounded-s relative left-5">4 new</button>
     <span class="text-sm text-blue-600 relative left-30">Clear all</span>       
           <hr></hr>
    <span class="font-bold">New! Booking flights from New York</span>
    <div>Find the flexible ticket on flights around the world.Start searching today </div>
    <div>05 Feb 2024</div>
     <span class="font-bold">sunshine saving are here save 30% or more on a stay</span>
     <div>24 Aug 2024</div>
                    </div>
                </div>
                <div className="group relative">
        ...
        <div className="absolute hidden group-hover:block border-none bg-white rounded-lg 
        shadow-lg w-70 h-70 top-18 right-5">
        <img class="rounded-full w-10 h-10 relative top-5 left-5" src="logo02.jpg"></img>
            ...
            <email class="absolute top-10 left-20">example@gmail.com</email>
                <ul class="relative top-10 left-8 ">
                    <li class="flex"> <CiBookmarkCheck size="20" />My Bookings</li>
                    <li class="flex"><CiHeart size="20"/>My Wishlist</li>
                    <li class="flex"><CiSettings size="20" />Settings</li>
                    <li class="flex"><IoMdHelpCircleOutline size="20" /> Help Center</li>
                    <li class="flex"> <LiaSignOutAltSolid size="20" />Sign Out</li>
                </ul>
              <h3 class="absolute top-60 flex">Mode: <IoSunnyOutline size="20" /></h3>
