...
<div class="manyimage ">
  <div class="px-20 py-20">
    ...
    <div>
    <a  class="hover:text-blue-500 text-xl px-5"href="#">
    <img  class="rounded-full w-35"src="11-GaBY5L70.jpg"></img><p class="text-center">New Keagan</p> </a>
     <p class="opacity-75  text-center">  35 mins drive</p>
    </div>
    <div>
    <a  class="hover:text-blue-500 text-xl px-5"href="#">
    <img  class="rounded-full w-35"src="01-SppmAcgj (1).jpg"></img> Osla</a>
        <p class="opacity-75  text-center"> 1 hour 13 mins drive</p>
    </div>
</div>
  </div>
</div>
<div class="container">
  ...
  <div class="flex-col ">
  <h2 class="font-bold text-xl p-2">24x7 Help</h2>
 <p class="opacity-75 p-2"> If we fall short of your expectation in any way, let us know</p>
 </div>

 <FaHandHoldingUsd  size="50"/>
 <div class="flex-col ">
  <h2 class="font-bold text-xl p-2">Payment Trust</h2>
 <p class="opacity-75 p-2"> All refunds come with no questions asked guarantee</p>
 </div>
</div>
</div>
 <div class="pl-20  pb-5">
  <h2 class="font-bold text-2xl">Downloaded app</h2>
  <div class="flex gap-8 pt-5 ">
  <a href="#"><img class="h-18" src="google-play-Oy7Jtnye.svg"></img></a>
