...
function Takeoff() {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      ...
      if (
        visibleSecondRef.current &&
        !visibleSecondRef.current.contains(event.target)
      ) {
    ...
    <>
      ...
      <div className="flex pt-10 pl-50">
        ...
        <div className=" border-none relative group hover:bg-sky-50 cursor-pointer">
          <a href="#Page">
            <ul className="flex items-center text-base pl-1 hover:text-blue-600">
              Travelers
          ...
          <div className="list-none border-none bg-white p-6 text-black-500 shadow-lg w-60 absolute hidden group-hover:flex flex-col">
            <li className="list-none font-bold flex">
              <FaHotel size={20} />
              Hotel
            </li>
        ...
        <div className="pl-20 flex gap-5 cursor-pointer">
          ...
          <div
            className="bg-blue-300 rounded-md text-sm w-22 p-1 
                     hover:bg-sky-600 hover:text-white flex"
          >
            <div className="flex">
              <button className="cursor-pointer flex gap-2">
                <FaArrowRightToBracket className="relative top-1" />
                sign Up{" "}
              </button>
            </div>
          </div>
      ...
      <div className="px-20 py-20">
        <div className="w-full pl-20 pr-15 pt-4 pb-8 h-[600px] bg-[url(/flight.jpg)]">
          <h1 className="font-extrabold text-7xl absolute top-110 left-60 tracking-wider">
            Ready to take off?
          </h1>
          <div className="w-full h-55 mt-75  left-10 bg-white">
            <div className="pt-5 pl-6 flex">
              <button className="bg-gray-300 rounded-l-lg px-4 py-2 text-black  font-semibold ">
                one way
              </button>
              <button className="bg-black rounded-r-lg text-white  font-semibold px-4 py-2">
                Round Trip
              </button>

              <div className="bg-gray-100 absolute left-155 rounded-md flex">
                <div
                  className={`w-[200px] py-2 text-gray-500 rounded-t-lg border ${
                    visible ? "border-b-1" : "border-transparent"
                  }`}
                >
                  <div
                    ref={visibleRef}
                    ...
                    id="class"
                    className=" px-1 relative flex items-center justify-between cursor-pointer "
                  >
                    <p>Select Class</p>
                    ...
                    <div
                      className={`z-50 bg-white w-[200px] absolute  top-8 left-0 ${
                        visible ? "flex" : "hidden"
                      } flex-col border px-2`}
                    >
                ...
                <div className="bg-gray-100 w-48 h-10 absolute left-55 rounded-md flex text-gray-500 pt-1">
                  <div
                    className={`w-[200px]  text-gray-500 rounded-t-lg border ${
                      visibleSecond ? "border-b-1" : "border-transparent"
                    }`}
                  >
                    <div
                      ref={visibleSecondRef}
                      onClick={() => {
                        setVisibleSecond(!visibleSecond);
                      }}
                      id="class"
                      className="px-1 relative flex justify-between cursor-pointer"
                    >
                      ...
                      <div
                        className={`z-50 bg-white w-[190px] absolute  top-8 left-0 ${
                          visibleSecond ? "flex" : "hidden"
                        } flex-col border px-2`}
                      >
                        <form>
                          <input type="text"></input>
            ...
            <div className="flex gap-4 relative top-4 left-4">
              <div className="bg-gray-100 w-70 rounded-lg  text-gray-500  cursor-pointer ">
                ...
                <div
                  ...
                  className={`w-60 px-2 py-3 relative left-2 top-0 bg-white flex-1/3 flex justify-between rounded-t-lg border border-b-0 ${
                ...
                >
                  ...
                  <div
                    className={`${
                      from ? "flex" : "hidden"
                    } absolute border top-10 left-0 flex-col bg-white w-60 rounded-b-lg `}
                  >
                    <input type="text" className="border-b-0 p-1 mb-1" />
                    <ul className="p-1">
                      <li className="list-none hover:bg-gray-200">
                        select location
                      </li>
                      <li className="list-none hover:bg-gray-200">
                        San Jacinto, USA
              ...
              <button className="cursor-pointer hover:bg-sky-50 bg-white rounded-full h-10  w-10 absolute top-7 left-66 ">
                {" "}
                <FaArrowRightArrowLeft size={26} className="pl-3" />
              </button>
                  ...
                  <div className={`top-14 left-0 `}>
                    ...
                    >
                      ...
                      <div
                        className={`${
                          to ? "flex" : "hidden"
                        } absolute top-10 left-0 flex-col items-center border bg-white w-full rounded-b-lg`}
                      >
              ...
              <div className="bg-gray-100  w-70 p-3 rounded-lg">
                <p className="text-gray-600 pl-3 text-sm  gap-1 flex">
      ...
      <div className="absolute top-193 left-230">
        <button className="flex cursor-pointer hover:bg-sky-700 text-white rounded-lg p-2 px-6 bg-blue-700 font-semibold">
          Find ticket
          <FaArrowRightLong size={19} className="pt-2 pl-2" />
        </button>
      </div>
      ...
      <div className="flex gap-5 py-10 pt-1">
        <div className="relative left-40 top-5 bg-blue-100 w-58 h-60 rounded-md">
          ...
          <div className="pl-4 pt-4">
            <div
              className="inline-block  border-dashed 
            ...
            <button className="cursor-pointer hover:bg-sky-50 bg-white rounded-full h-12 w-12 relative left-10 ">
              <FaArrowRightLong size={29} className="pl-4" />
            </button>
          </div>
        </div>
      ...
      <div className="flex py-10 pl-25 pr-20 cursor-pointer">
        ...
        <div>
          ...
          <p className="text-gray-500 text-md pl-1">
      ...
      <div className="flex gap-20">
        <div className="pl-45 py-10">
          ...
          <p className="text-gray-500 text- pt-3">
            Total 630+ destinations that we work with
          </p>
        </div>
        <div className="py-10">
          <img
            className="w-45 pt-10 pl-10"
            src="public/step-2-FFQO7UxQ.svg"
          ></img>
          <p className="font-bold text-xl pt-2">Select Destination</p>
          <p className="text-gray-500 text-md pt-3">
      ...
      <div className="pl-25 pr-25 py-10 ">
        <div className="bg-blue-100 w-full h-45 rounded-2xl">
          ...
          <div className="absolute top-575 left-240 ">
            <button className="bg-black  font-semibold text-white p-3 px-6 rounded-xl">
              Book a flight
            </button>
          </div>
        </div>
      ...
      <div className=" py-10 pl-30">
        ...
        <div>
          <p className="text-3xl font-bold hover:text-blue-800 cursor-pointer">
            10 ways on How to Improve your<br></br> Hotel Operations
          </p>
        </div>
        ...
        <div className="flex-col">
          <div className="absolute top-633 left-170">
            <div className="flex">
              <img
                className="w-37 rounded-xl"
                src="public/02-HjfkwpD3.jpg"
              ></img>
              <div className="flex-col">
                <p className="text-xl pt-8 px-5 hover:text-blue-800 cursor-pointer font-bold">
                  Story of Water World adventure
                </p>
                <p className="text-gray-500 px-6 pt-2 cursor-pointer">
                  Jacqueline Miller
                </p>
              </div>
            </div>
